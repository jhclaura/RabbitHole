...
function update(){
	...
	//GET_CARROTS
	for(var i=0; i<speakBoxes.length; i++){
		if(speakBoxes[i].position.x-1 < pointerControls.posX()
			&& speakBoxes[i].position.x+1 > pointerControls.posX()
			&& speakBoxes[i].position.z-1 < pointerControls.posZ()
			&& speakBoxes[i].position.z+1 > pointerControls.posZ()
			)
		{
